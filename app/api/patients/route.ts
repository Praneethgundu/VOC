  ...
  try {
    ...
    const newPatient = await prisma.patient.create({
      data: {
        ...
        bloodGroup: (!data.bloodGroup || data.bloodGroup === "") ? null : data.bloodGroup,
  ...
  try {
    ...
    const updated = await prisma.patient.update({
      ...
      data: {
        ...
        bloodGroup: data.bloodGroup !== undefined ? ((!data.bloodGroup || data.bloodGroup === "") ? null : data.bloodGroup) : existing.bloodGroup,
