          ...
          >
            <div className="flex flex-col md:flex-row gap-8 items-center justify-between">
              <div className="max-w-[400px]">
                <p className="text-[14px] font-semibold text-[#1A2332]">Export Database</p>
              ...
              <div className="w-[1px] h-24 bg-[#ECECEC] hidden md:block" />

              <div className="max-w-[400px]">
                <p className="text-[14px] font-semibold text-[#1A2332]">Restore Database</p>
                <p className="text-[12px] text-[#6B7280] mt-0.5">
                  Upload a previously exported VOC HMS Excel backup file to restore all records. <span className="text-[#E12D45] font-semibold">Warning: This will overwrite all current database tables!</span>
                </p>
