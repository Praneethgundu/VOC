...
import { getReceptionEodReport } from "@/services/reportService";
import ReceptionEOD from "@/components/reports/ReceptionEOD";

export default function ReceptionEODPage() {
  ...
  const fetchReport = async () => {
    ...
    setReport(null);
    try {
      setReport(await getReceptionEodReport(selectedDate));
    } catch (e) {
      console.error(e);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="flex bg-[#F8FAFC] min-h-screen">
      ...
      <div className="ml-[248px] print:ml-0 flex-1 flex flex-col min-h-screen print:bg-white">
        <div className="print:hidden">
          <Navbar pageTitle="Reception EOD Report" breadcrumb="Reports" />
        </div>
